...
class DeepLabV3(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=1, output_stride=16):
        ...
        self.classifier = nn.Sequential(nn.Conv2d(256, 256, 3, padding=1, bias=False), nn.BatchNorm2d(256), nn.ReLU(inplace=True), nn.Dropout(0.1), nn.Conv2d(256, num_classes, 1))
        self._init_weight()
...
def create_deeplabv3(num_classes=1, output_stride=16):
    return DeepLabV3(in_channels=3, num_classes=num_classes, output_stride=output_stride)
